<?php
session_start();
$con = mysqli_connect("Localhost", "gesundco_root", "gesundco123", "gesundco_gesundpharma");
?>
<!DOCTYPE HTML>
                ...
                <div class="inner relative">
                    ...
                    <nav id="navigation">
                        <ul id="main-menu">
                            ...
                            <li class="current-menu-item"><a href="shippers.php">Shippers</a></li>
                            <li>
...
<div class="product-model">	 
	 <div class="container">
			<ol class="breadcrumb">
                            <li><a href="index.php">Home</a></li>
                            <li class="parent"><a href="shippers.php">Shippers</a></li>
                        </ol>
			<h2>OUR SHIPPERS</h2>			
		 <div class="col-md-9 product-model-sec">
                    <?php
                        $res=$con->query("Select * from shippers");
                        while($row = $res->fetch_assoc())
                        {
                    ?>   
                         <div class="product-grid love-grid">
        			<div class="product-img b-link-stripe b-animate-go thickbox">
                                    <img src="<?php echo $row["ship_Img"]?>" class="img-responsive"/>
                                     Dropshipping made easy Start a hands-free online business with Shopify. Have your products shipped directly to your customers
                                    <div class="b-wrapper">
