	 ...
	 <div class="container">
			<ol class="breadcrumb">
                    ...
                    <?php
                        ...
                        ?>
                            <li class="parent"><a href="products.php">Products</a></li>
                            <li><a href="demoprod.php?type=<?php echo $headrow["prod_type"]?>">
					 ...
					 <div class="product_right">
						<h4 class="m_2">
						 ...
						 <div class="tab<?php echo $tabnum;?>">
							 <ul class="place">								
                                                             <li class="sort">
                                                                 <a href="demoprod.php?type=<?php echo $row["prod_type"]?>"><?php echo $row["prod_type"]?></a>
                                                             </li>
...
<div class="footer-content">
	 <div class="container">
		 <div class="ftr-grids">
			 ...
			 <div class="clearfix"></div>
                         <div class="copywrite">
                		 <p>Copyright © 2016 ePHARMA All rights reserved</p>
                         </div>			 
